...
project$HeartDisease<-ifelse(heart$HeartDisease=="Yes",1,0)
project$Smoking<-ifelse(heart$Smoking=="Yes",1,0)
project$AlcoholDrinking<-ifelse(heart$AlcoholDrinking=="Yes",1,0)
project$Diabetic<-ifelse(heart$Diabetic=="Yes",1,0)
