...
```{r}
barplot(table(project1$HeartDisease,project1$Diabetic), legend= rownames(table(project1$HeartDisease,project1$Diabetic)), col =(c("green", "brown")),xlab="Heartdiease",ylab="Diabetic", main = "Barplot for Heartdisease and Diabetic")
```
