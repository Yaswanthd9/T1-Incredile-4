...
#Distribution of heart disease over age
```{r}
count = table(heart$HeartDisease, heart$AgeCategory)
barplot(count, col = c("green","red"), legend.text = c("no", "yes"), args.legend = list(x = "topright"), xlab = "Age category", ylab = "count")
```
