...
From, the VIF table, The VIF value for sleep time is 11.3, this is undesirable and thus will be dropped. Race is pretty above 5 for whites and other races, race as a variable will be dropped. We will train and test the model to see the cost analysis of our predictions. 
...
According to model, the odds ratio for getting heart disease increases by 2.07 for a man compared to a woman. While an increase in BMI increases the log odds for heart disease by 1.02. 
...
coefficients are narrow in the beginning but get wider as age goes up. This means that there are some other things that affect HD other than sex and age
