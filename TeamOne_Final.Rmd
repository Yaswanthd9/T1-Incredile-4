...
From, the VIF values, VUF for sleep time is 11.3 so we will drop. 
...
model_2<- glm(HeartDisease~ Sex+ BMI + PhysicalHealth+ MentalHealth +  AgeCategory + Race, data=train, family='binomial')
summary(model_2)
```
```{r}
