...
# Correlation Plots of All Variables ###DELETE
```{r, results = 'markup'}
...
# Correlation Plot for Gender Dataframe 

```{r}

# Creating dataframe for sex and related variables
gender <- data.frame (  heart$HeartDisease,
                        heart$BMI,
                        heart$AgeCategory,
                        heart$Sex,
                        heart$PhysicalHealth,
                        heart$MentalHealth,
                        heart$SleepTime,
                        heart$GenHealth)
heart
...
<<<<<<< HEAD:TeamOne_FinalRmd.Rmd
```{r}
=======
#```{r}

<<<<<<< Updated upstream
>>>>>>> 4f9915b752c18dd701345dd5f20b34e9d1ee6a04:TeamOne_Summary1.Rmd
