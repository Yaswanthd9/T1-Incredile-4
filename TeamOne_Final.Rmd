...
```{r}
model <- glm(HeartDisease ~ GenHealth+PhysicalActivity+SleepTime,data=train,family = "binomial")
summary(model)
```

A model is built on Gen Health, Physical Activity, Sleeptime, Race. All the p-values are less than 0.05 except the RaceAsian remaining all the stastically significant.
