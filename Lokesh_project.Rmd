...
```{r, results='markup'}
library(ggplot2)
ggplot(patient, aes(x=Diabetic)) + geom_bar(color="blue",fill=rgb(0.1,0.4,0.5,0.7) )
dia_pa<-subset(patient,Diabetic==1)
nrow(dia_pa)
ggplot(na_patient, aes(x=Diabetic)) + geom_bar(color="blue",fill=rgb(0.1,0.4,0.5,0.7) )
...
```{r, results='markup'}
ggplot(patient, aes(x=Asthma)) + geom_bar(color="blue",fill=rgb(0.1,0.4,0.5,0.7) )
ast_pa<-subset(patient,Asthma==1)
nrow(ast_pa)
ggplot(na_patient, aes(x=Asthma)) + geom_bar(color="blue",fill=rgb(0.1,0.4,0.5,0.7))+ scale_y_continuous(labels = scales::comma)
...
```{r, results='markup'}
ggplot(patient, aes(x=KidneyDisease)) + geom_bar(color="blue",fill=rgb(0.1,0.4,0.5,0.7) )
kid_pa<-subset(patient,KidneyDisease==1)
nrow(kid_pa)
ggplot(na_patient, aes(x=KidneyDisease)) + geom_bar(color="blue",fill=rgb(0.1,0.4,0.5,0.7) )
...
```{r, results='markup'}
ggplot(patient, aes(x=SkinCancer)) + geom_bar(color="blue",fill=rgb(0.1,0.4,0.5,0.7) )
skin_pa<-subset(patient,SkinCancer==1)
nrow(skin_pa)
ggplot(na_patient, aes(x=SkinCancer)) + geom_bar(color="blue",fill=rgb(0.1,0.4,0.5,0.7) )
