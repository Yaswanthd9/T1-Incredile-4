...
```{r}
heart_des<-subset(heart,select = c(HeartDisease,Diabetic,Asthma,KidneyDisease,SkinCancer,Stroke))
str(heart_des)
...
```{r q03subset}
smoke <-  subset(heart,Smoking==1)
smoke
smoke0 <- subset(heart,Smoking==0)
smoke0
drink<-   subset(heart,AlcoholDrinking==1)
drink
drink0 <- subset(heart,AlcoholDrinking==0)
drink0
```
