...
```{r}
barplot(table(total$PhysicalActivity, total$HeartDisease), legend= rownames(table(total$HeartDisease, total$PhysicalActivity)), col =(c("orange", "blue")), xlab="PhysicalActivity", ylab="heartdisease",main = "Barplot for Heartdisease and PhysicalActivity")
```
