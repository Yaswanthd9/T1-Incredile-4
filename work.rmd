...
# 
cm_info <- ConfusionMatrixInfo( data = test, predict = "prediction", actual = 'HD', cutoff = 0.27 )
#ggthemr("flat")
plot(cm_info$plot)
...
# 
cm_info3 <- ConfusionMatrixInfo( data = test, predict = "prediction", actual = 'HD', cutoff = 0.27 )
#ggthemr("flat")
plot(cm_info3$plot)
